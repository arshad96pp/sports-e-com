...
import { uploadBannerImageAction } from "@/lib/actions/admin/banner-actions";
  ...
  return (
    <div>
      ...
      <button
        ...
        disabled={isPending}
        className="relative flex h-16 w-28 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-dashed border-border-strong bg-surface text-muted hover:border-ink"
      >
